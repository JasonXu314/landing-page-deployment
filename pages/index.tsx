    ...
    return (
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                <div className={styles.info}>
                    ...
                    <div className={styles.mailing}>
                        ...
                        <p className={styles.subtext}>
                            ...
                            <a className={styles.sponsor} onClick={() => (window.location.href = 'mailto:pickhacks@mst.edu?subject=Sponsorship')}>
                                Click here
                            </a>
                        </p>
                    </div>
                ...
                {onClient && !matches && (
                    <div
                        style={{ width: '40%', height: '100%', overflow: 'visible', position: 'fixed', right: 0, top: 0 }}
                        ref={(elem) => {
                            if (elem) {
